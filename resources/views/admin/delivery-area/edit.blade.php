            ...
            <div class="card-body">
                <form action="{{ route('admin.delivery-area.update',$area->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="min_delivery_area" class="form-control"  value="{{ $area->min_delivery_area }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Maximum Delivery Time</label>
                                <input type="text" name="max_delivery_area" class="form-control"  value="{{ $area->max_delivery_area }}">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <input type="number" name="delivery_fee" class="form-control" value="{{ $area->delivery_fee }}">
                    </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
