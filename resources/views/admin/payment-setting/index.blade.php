                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-2">
                      <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#jazzcash-setting" role="tab" aria-controls="contact" aria-selected="false">Jazzcash</a>
                        </li>
                      </ul>
                    </div>
                    <div class="col-12 col-sm-12 col-md-10">
                     ...
                     @include('admin.payment-setting.sections.stripe')
                      ...
                      @include('admin.payment-setting.sections.jazzcash')
