        ...
        return (new EloquentDataTable($query))
            ...
            return date('d-m-Y',strtotime($query->created_at));
             ...
             ->addColumn('action', function ($query) {
                ...
                $status = "<a href='" . route('admin.slider.edit', $query->id) . "' class='btn btn-warning ml-2'>
                <i class='fas fa-truck-loading'></i></a>";

                $delete = "<a href='" . route('admin.slider.destroy', $query->id) . "' class ='btn btn-danger delete-item ml-2'>
